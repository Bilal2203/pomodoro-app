  ...
  return (
    <div className="headtext">
      ...
      <ul>
        <li>
          {" "}
          <b>Responsive design</b> that works with desktop and mobile
        </li>
        <li>
          {" "}
          <b>Color transition</b> to switch moods between work time and rest
          time
        </li>
        <li>
          {" "}
          <b>Audio notification </b> at the end of a timer period
        </li>
        <li>
          {" "}
          <b>Customizable timer </b> intervals to suit your preference
        </li>
      </ul>
      ...
      <ul className="ul">
        <li>
          For macOS <span>(zip file)</span>{" "}
        </li>
        <li>
          For Windows <span>(zip file)</span>{" "}
        </li>
      </ul>
      <hr className="lasthr" />
      ...
      <p className="made">
        Made with by <span className="bilu">BILAL</span>{" "}
      </p>
